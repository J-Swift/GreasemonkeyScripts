...
for( var i in table_rows ) {
    try {
        player_name = table_rows[i].firstChild.firstChild.textContent;
        owner_name = table_rows[i].lastElementChild.textContent;
...
var the_table = document.querySelector(".Table-mid");
var yahoo_main_content_body = document.querySelector(".Mod .Thm-inherit")
